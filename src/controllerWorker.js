...
const nestController = new NestController(logs.controller, knex, cachingGeocoder, scannerQuery, cachingGeocoder, config, dts, geofence, GameData, rateLimitedUserCache, translatorFactory, mustache, controllerWeatherManager, statsData, eventParsers)

									...
									this.getAddress({ lat: data.latitude, lon: data.longitude }).then((geoResult) => {
										...
										whoCares.forEach((cares) => {
											...
											const view = _.extend(data, {
												...
												move1emoji: data.quick_move in moveData ? moveData[data.quick_move]['type'] ? types[moveData[data.quick_move]['type']]['emoji'] : '' : '',
												move2emoji: data.charge_move in moveData ? moveData[data.charge_move]['type'] ? types[moveData[data.charge_move]['type']]['emoji'] : '' : '',
												level: data.level,
												ex: data.ex,

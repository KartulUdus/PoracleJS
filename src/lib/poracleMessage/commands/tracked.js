...
function gymRowText(config, translator, GameData, gym) {
	...
	return `**${raidTeam} ${translator.translate('gyms')}** ${gym.distance ? ` | ${translator.translate('distance')}: ${gym.distance}m` : ''} ${standardText(config, translator, gym)}`
}

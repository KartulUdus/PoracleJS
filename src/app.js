	...
	try {
		...
		switch (hook.type) {
			...
			case 'raid': {
				...
				fastify.webhooks.info('raid', { hook: hook.message })
			...
			case 'pokestop': {
				...
				fastify.webhooks.info('pokestop', { hook: hook.message })
			...
			case 'quest': {
				...
				fastify.webhooks.info('quest', { hook: hook.message })
			...
			case 'weather': {
				...
				fastify.webhooks.info('weather', { hook: hook.message })
